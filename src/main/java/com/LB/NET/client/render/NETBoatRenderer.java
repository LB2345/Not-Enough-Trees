package com.BubbleTeaM.NET.client.render;
...
public class NETBoatRenderer extends EntityRenderer<NETBoat> {
    private final Map<NETBoat.Type, Pair<ResourceLocation, BoatModel>> boatResources;

    public NETBoatRenderer(EntityRendererProvider.Context p_173936_) {
        super(p_173936_);
        this.shadowRadius = 0.8F;
        this.boatResources = Stream.of(NETBoat.Type.values()).collect(ImmutableMap.toImmutableMap((p_173938_) -> {
            return p_173938_;
        }, (p_173941_) -> {
            return Pair.of(new ResourceLocation("textures/entity/boat/" + p_173941_.getName() + ".png"), new BoatModel(p_173936_.bakeLayer(NETModelLayers.createNETBoatModelName(p_173941_))));
        }));
    }

    public void render(NETBoat p_113929_, float p_113930_, float p_113931_, PoseStack p_113932_, MultiBufferSource p_113933_, int p_113934_) {
        p_113932_.pushPose();
    ...
    @Deprecated
    public ResourceLocation getTextureLocation(NETBoat p_113927_) {
        return getModelWithLocation(p_113927_).getFirst();
    }

    public Pair<ResourceLocation, BoatModel> getModelWithLocation(NETBoat boat) {
    ...
    public Pair<ResourceLocation, BoatModel> getModelWithLocation(NETBoat boat) { return this.boatResources.get(boat.getBoatType()); }
}
