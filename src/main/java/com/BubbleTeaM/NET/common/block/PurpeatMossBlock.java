...
import com.BubbleTeaM.NET.common.worldgen.features.NETConfiguredFeatures;
...
public class PurpeatMossBlock extends Block implements BonemealableBlock {
    public PurpeatMossBlock(BlockBehaviour.Properties p_153790_) {
        super(p_153790_);
    }
    ...
    public void performBonemeal(ServerLevel p_153792_, Random p_153793_, BlockPos p_153794_, BlockState p_153795_) {
        NETConfiguredFeatures.PURPEAT_MOSS_PATCH_BONEMEAL.value().place(p_153792_, p_153792_.getChunkSource().getGenerator(), p_153793_, p_153794_.above());
    }
}
