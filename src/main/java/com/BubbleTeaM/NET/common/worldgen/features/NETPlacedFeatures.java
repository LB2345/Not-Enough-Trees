...
public class NETPlacedFeatures  {
    ...
    public static final Holder<PlacedFeature> ENDBURST_PLACED = PlacementUtils.register("endburst_placed",
            NETConfiguredFeatures.ENDBURST_SPAWN, VegetationPlacements.treePlacement(PlacementUtils.countExtra(5, 0.1F, 1)));
}